...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
    <form id="addProductForm" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <input type="text" name="name"  value="{{ old('name') }}" placeholder="e.g. iPhone 15 Pro Max"
            ...
            <div>
                ...
                <input type="number" name="price" min="1" step="0.01"  value="{{ old('price') }}" placeholder="0.00"
                    class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-slate-700">
            ...
            <div>
                ...
                <input type="number" name="stock" min="0"  value="{{ old('stock') }}" placeholder="e.g. 50"
                    class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-slate-700">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <textarea name="description" rows="4" placeholder="Briefly describe the product features..."
                    class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-slate-700 resize-none">{{ old('description') }}</textarea>
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div id="imagePreviewContainer" class="hidden w-32 h-32 rounded-xl border border-slate-200 bg-slate-50 overflow-hidden flex-shrink-0 relative shadow-sm">
                        <img id="imgPreview" class="w-full h-full object-contain p-2">
                        <button type="button" onclick="clearImage()" class="absolute top-1 right-1 bg-white rounded-full p-1 shadow text-slate-400 hover:text-rose-500 transition-colors" title="Remove Image">
